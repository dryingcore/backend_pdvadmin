...
export const eventoComissionados = pgTable(
  ...
  table => [
    uniqueIndex('unique_evento_comissionado').using(
      'btree',
      table.eventoId.asc().nullsLast().op('uuid_ops'),
      table.comissionadoId.asc().nullsLast().op('uuid_ops'),
    ),
  ],
);
...
export const eventoLojas = pgTable(
  ...
  table => [
    uniqueIndex('unique_evento_loja').using(
      'btree',
      table.eventoId.asc().nullsLast().op('uuid_ops'),
      table.lojaId.asc().nullsLast().op('uuid_ops'),
    ),
  ],
);
...
export const fechamentosEvento = pgTable(
  ...
  table => [uniqueIndex('unique_evento_id_fechamento').using('btree', table.eventoId.asc().nullsLast().op('uuid_ops'))],
);
...
export const taxasEvento = pgTable(
  ...
  table => [uniqueIndex('unique_evento_id').using('btree', table.eventoId.asc().nullsLast().op('uuid_ops'))],
);
...
export const taxasPersonalizadasLoja = pgTable(
  ...
  table => [uniqueIndex('unique_loja_id').using('btree', table.lojaId.asc().nullsLast().op('uuid_ops'))],
);
...
export const transacoesDiarias = pgTable(
  ...
  table => [
    uniqueIndex('unique_evento_loja_data').using(
      'btree',
      table.eventoId.asc().nullsLast().op('text_ops'),
      table.lojaId.asc().nullsLast().op('uuid_ops'),
      table.dataTransacao.asc().nullsLast().op('text_ops'),
    ),
  ],
);
